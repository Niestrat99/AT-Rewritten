...
public class WarpSQLManager extends SQLManager {
    ...
    public void transferOldData() {
        ...
        // Get the file itself.
        File file = new File(CoreAdvancedTeleport.getInstance().getPlugin().getDataFolder(), "warps.yml");
        ...
        file.renameTo(new File(CoreAdvancedTeleport.getInstance().getPlugin().getDataFolder(), "warps-backup.yml"));
    }
    ...
    public CompletableFuture<Integer> getWarpId(String name) {
        return CompletableFuture.supplyAsync(() -> getWarpIdSync(name), CoreAdvancedTeleport.async);
    }
