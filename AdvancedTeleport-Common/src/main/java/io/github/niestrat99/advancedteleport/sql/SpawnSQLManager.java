...
public class SpawnSQLManager extends SQLManager {
    ...
    public void transferOldData() {
        ...
        // Get the file itself.
        File file = new File(CoreAdvancedTeleport.getInstance().getPlugin().getDataFolder(), "spawn.yml");
        ...
        file.renameTo(new File(CoreAdvancedTeleport.getInstance().getPlugin().getDataFolder(), "spawn-backup.yml"));
    }
    ...
    public CompletableFuture<Void> addSpawn(@NotNull Spawn spawn) {
        return CompletableFuture.runAsync(() -> addSpawn(
                ...
                spawn.getLocation().getPitch()), CoreAdvancedTeleport.async);
    }
    ...
    public CompletableFuture<Void> removeSpawn(String name) {
        return CompletableFuture.runAsync(() -> removeSpawnSync(name), CoreAdvancedTeleport.async);
    }
