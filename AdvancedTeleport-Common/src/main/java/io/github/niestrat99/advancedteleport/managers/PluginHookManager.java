...
public final class PluginHookManager {
    ...
    public boolean isClaimed(@NotNull final Location location) {
        ...
        CoreAdvancedTeleport.debug("Check initiated to see if " + location + " is claimed.");
        ...
        return getPluginHooks(ClaimPlugin.class, true)
                ...
                .anyMatch(hook -> {
                    ...
                    CoreAdvancedTeleport.debug("Claim result for " + hook.pluginName() + ": " + result);
                    return result;
                });
    }
    ...
    private <T> void addIcons(
        ...
        pois.thenAcceptAsync(result -> result.forEach(handler), CoreAdvancedTeleport.sync);
    }
}
