...
final class CraftTeam extends CraftScoreboardComponent implements Team {
    ...
    public void addEntities(java.util.Collection<org.bukkit.entity.Entity> entities) throws IllegalStateException, IllegalArgumentException {
        this.addEntries(entities.stream().map(entity -> ((org.bukkit.craftbukkit.v1_19_R1.entity.CraftEntity) entity).getHandle().getScoreboardName()).toList());
    }
    ...
    public boolean removeEntities(java.util.Collection<org.bukkit.entity.Entity> entities) throws IllegalStateException, IllegalArgumentException {
        return this.removeEntries(entities.stream().map(entity -> ((org.bukkit.craftbukkit.v1_19_R1.entity.CraftEntity) entity).getHandle().getScoreboardName()).toList());
    }
    ...
    public void addEntity(org.bukkit.entity.Entity entity) throws IllegalStateException, IllegalArgumentException {
        ...
        this.addEntry(((org.bukkit.craftbukkit.v1_19_R1.entity.CraftEntity) entity).getHandle().getScoreboardName());
    }

    @Override
    public boolean removeEntity(org.bukkit.entity.Entity entity) throws IllegalStateException, IllegalArgumentException {
        Validate.notNull(entity, "Entity cannot be null");
        return this.removeEntry(((org.bukkit.craftbukkit.v1_19_R1.entity.CraftEntity) entity).getHandle().getScoreboardName());
    }

    @Override
    public boolean hasEntity(org.bukkit.entity.Entity entity) throws IllegalStateException, IllegalArgumentException {
        Validate.notNull(entity, "Entity cannot be null");
        return this.hasEntry(((org.bukkit.craftbukkit.v1_19_R1.entity.CraftEntity) entity).getHandle().getScoreboardName());
    }
    // Paper end
