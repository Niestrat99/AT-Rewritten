...
public class CraftArmorStand extends CraftLivingEntity implements ArmorStand {
    ...
    public ItemStack getItem(org.bukkit.inventory.EquipmentSlot slot) {
        ...
        return getHandle().getItemBySlot(org.bukkit.craftbukkit.v1_19_R1.CraftEquipmentSlot.getNMS(slot)).asBukkitMirror();
    }
    ...
    public void setDisabledSlots(org.bukkit.inventory.EquipmentSlot... slots) {
        ...
        for (org.bukkit.inventory.EquipmentSlot slot : slots) {
            ...
            net.minecraft.world.entity.EquipmentSlot nmsSlot = org.bukkit.craftbukkit.v1_19_R1.CraftEquipmentSlot.getNMS(slot);
    ...
    public boolean isSlotDisabled(org.bukkit.inventory.EquipmentSlot slot) {
        return getHandle().isDisabled(org.bukkit.craftbukkit.v1_19_R1.CraftEquipmentSlot.getNMS(slot));
    }
