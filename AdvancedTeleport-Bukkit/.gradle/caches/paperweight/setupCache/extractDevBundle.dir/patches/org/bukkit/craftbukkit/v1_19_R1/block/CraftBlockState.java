...
public class CraftBlockState implements BlockState {
    ...
    public java.util.Collection<org.bukkit.inventory.ItemStack> getDrops(org.bukkit.inventory.ItemStack item, org.bukkit.entity.Entity entity) {
        net.minecraft.world.item.ItemStack nms = org.bukkit.craftbukkit.v1_19_R1.inventory.CraftItemStack.asNMSCopy(item);
        ...
        if (item == null || !data.requiresCorrectToolForDrops() || nms.isCorrectToolForDrops(data)) {
            return net.minecraft.world.level.block.Block.getDrops(
                ...
                world.getHandle().getBlockEntity(position), entity == null ? null :
                    ((org.bukkit.craftbukkit.v1_19_R1.entity.CraftEntity) entity).getHandle(), nms
            ).stream().map(org.bukkit.craftbukkit.v1_19_R1.inventory.CraftItemStack::asBukkitCopy).toList();
        } else {
