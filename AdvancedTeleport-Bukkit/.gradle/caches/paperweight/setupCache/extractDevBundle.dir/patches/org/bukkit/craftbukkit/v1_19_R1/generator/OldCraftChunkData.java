...
public final class OldCraftChunkData implements ChunkGenerator.ChunkData {
    ...
    private LevelChunkSection getChunkSection(int y, boolean create) {
        ...
        if (create && section == null) {
            this.sections[offset] = section = new LevelChunkSection(offset + (this.minHeight >> 4), this.biomes, null, this.world instanceof org.bukkit.craftbukkit.v1_19_R1.CraftWorld ? ((org.bukkit.craftbukkit.v1_19_R1.CraftWorld) this.world).getHandle() : null); // Paper - Anti-Xray - Add parameters
        }
        return section;
    }
