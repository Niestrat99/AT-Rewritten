...
public abstract class ParticlesPlugin<P extends Plugin, R> extends PluginHook<P, R> {
    ...
    /**
     * Attempts to remove the particles from a player that were applied when the command has
     * finished.
     *
    ...
    /**
     * Gets a readable string of the particles applied to the player. Returns null if there are no
     * particles.
     *
     * <p>The string is formatted as PARTICLE;PARTICLE;PARTICLE - for each particle, internal data
     * is separated by ,.
     *
     * <p>The data should be parsed by the Particle Plugin class itself and not outside of it.
     *
