...
public final class RemoveSpawn extends SpawnATCommand {
    ...
    public boolean onCommand(
        ...
        // If there's no arguments specified, use the player's world - unless they aren't a player,
        // in which case, banish
        if (args.length == 0) {
        ...
        if (spawn == null) {
            CustomMessages.sendMessage(
                    sender, "Error.noSuchSpawn", Placeholder.unparsed("spawn", removingSpawn));
            return true;
        }
